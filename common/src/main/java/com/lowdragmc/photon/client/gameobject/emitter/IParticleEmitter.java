...
import com.lowdragmc.photon.client.gameobject.IGameObject;
...
public interface IParticleEmitter extends IGameObject, IConfigurable, ILDLRegisterClient, IAutoPersistedSerializable {
    ...
    default void buildConfigurator(ConfiguratorGroup father) {
        ConfiguratorParser.createConfigurators(father, new HashMap<>(), getTransform().getClass(), getTransform());
