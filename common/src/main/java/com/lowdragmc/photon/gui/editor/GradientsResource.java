...
import com.lowdragmc.photon.client.data.number.color.GradientColorTexture;
import com.lowdragmc.photon.client.data.number.color.RandomGradientColorTexture;
