...
public class CurveConfigurator extends ValueConfigurator<Curve> {
    ...
    public CurveConfigurator(String name, Supplier<Curve> supplier, Consumer<Curve> onUpdate, @Nonnull Curve defaultValue, boolean forceUpdate) {
        ...
        upperBound.setTextResponder(text -> value.setMax(Mth.clamp(Float.parseFloat(text), value.getMin(), value.getMax())));
        ...
        lowerBound.setTextResponder(text -> value.setMin(Mth.clamp(Float.parseFloat(text), value.getMin(), value.getMax())));
