            ...
            try {
                ...
                for (int i = 0; i < MATERIAL_COUNT; i++) {
                    ...
                    var material = switch (i % 3) {
                        case 0 -> new TextureMaterial(ResourceLocation.parse("photon:textures/particle/smoke.png"));
                        case 1 -> new CustomShaderMaterial(ResourceLocation.parse("photon:circle"));
                        default -> graphs.length == 0
                                ? new CustomShaderMaterial(ResourceLocation.parse("photon:circle"))
