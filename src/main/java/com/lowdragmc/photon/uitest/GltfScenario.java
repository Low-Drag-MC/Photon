 ...
 * model-source registry, a {@link ResourceLocation} resolved by the injected resource pack, and the
...
public class GltfScenario implements UIScenario {
    ...
    private static PhotonMesh load(TestContext ctx, ResourceLocation location, String what) {
        var source = new GltfModelSource(location);
